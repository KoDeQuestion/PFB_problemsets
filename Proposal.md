...
A ranked list of labs based on matched attributes factoring in the weighted importance to the student!
#### Potential challenges that may be encountered

Determining how to associate importance to a given attribute. 
